...
e_animal.bind("<Return>",lambda e :tree_dummy_handler(e,macho,"animal",self.e_animal,self.e_peso))
e_peso.bind("<Return>",lambda e :tree_dummy_handler(e,macho,"peso",self.e_animal,self.e_peso))
